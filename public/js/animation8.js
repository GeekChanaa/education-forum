...
window.onload = function() {
    ...
    var pathOptions = [{color: '#DD6845',opacity: 1,angle: -50, position: 'TL',x: -400,y: -600,scale: 1},
                        {color: '#F49377',opacity: 0.5,angle: 0, position: 'BR',x: 100,y: 270,scale: 1.3},
                        {color: '#DD6845',opacity: 0.47,angle: 0, position: 'BR',x: 400,y: 280,scale: 1.3},
                        {color: '#DD6845',opacity: 0.61,angle: 180, position: 'TR',x: 300,y: -55,scale: 1}];
