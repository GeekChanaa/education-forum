...
<main id="tt-pageContent">
    <div class="container">
        <div class="tt-wrapper-inner">
            ...
            <form class="form-default form-create-topic" action="{{url('/add_post')}}" method="post">
@csrf
                <div class="form-group">
                    <label for="inputTopicTitle">Topic Title</label>
                    <input type="hidden" name="section_id" value="{{$section->id}}">
                    <div class="tt-value-wrapper">
                        <input type="text" class="form-control" id="inputTopicTitle" placeholder="Subject of your topic" name="title">
